...
class Order_info_page(Base):
    ...
    def check_information(self):
        ...
        self.assert_word(self.get_order_number(), re.sub("[^0-9.]", "", self.get_order_number_title().text))
        self.assert_word(self.get_all_sum(), re.sub("[^0-9.]", "", self.get_final_price().text))
